...
int main() {
    std::string startFEN = "rnbqkbnr/pppppppp/8/8/pP6/8/PPPPPPPP/RNBQKBNR w KQkq b3 0 1";
    std::cout << "=== Move Generation Tests ===\n\n";
    int failed = 0;

    // Knight from b1 → a3, c3
    failed += !testMoveGeneration(startFEN, "a4", {"a3","b3"});
